...
puts burnaby = Store.find_by(name: 'Kelowna')
store = Store.create(name: "Lake Country", annual_revenue:  mens_apparel:  womens_apparel: )

# Error from console
# syntax error, unexpected tLABEL
# ... annual_revenue:  mens_apparel:  womens_apparel: )
